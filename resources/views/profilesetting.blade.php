                  ...
                  <div class="card-body">
                    ...
                    <form action="{{url('/') }}/profile" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <label class="form-label" for="basic-icon-default-vendorname">Username:</label>

                        <div class="input-group input-group-merge">

                          <input type="text" value="{{$pagedata->username}}" class="form-control" name="username" required />
                      ...
                      <img id="output" style="height:150px;width:auto"/>
                    </div>
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <label class="form-label" for="basic-icon-default-phone">Current Profile Picture :</label>

                        <div class="input-group input-group-merge">

                        <p><a href="{{ asset('uploads/profile_image/' .$pagedata->profile_image)}}" class="" target="blank"><img class="table_img" src="{{ asset('uploads/profile_image/' .$pagedata->profile_image)}}" style="width:auto; height:150px;"></a></p>
                      ...
                      <div class="mb-3 ">
                         <div>
                          ...
                          <input accept="image/*" type="file" name="profile_image"  onchange="loadFile(event)" class="form-control" />
