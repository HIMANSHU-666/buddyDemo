                ...
                <div class="container mt-3">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            ...
                            <div class="card">
                                <h5 class="card-header">View Sub Partner Details</h5>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn btn-success btn-xs ms-auto">Agent</div>
                                                    @else

                                                    <button class="btn btn-primary btn-xs mx-auto" onclick="agentDetail({{$data->id}},{{$data->agent_id}})">Agent Details</button>
                                                    <div class="collapse" id="{{'collapseExample'.$data->id}}">
                                                        <div class="card card-body">
                                                            <table id="agent_detail">
                                                                <tr>
                                                                    <th>Partner Name :</th>
                                                                    <td id="{{'agent_name'.$data->id}}"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Partner Phone :</th>
                                                                    <td id="{{'agent_phone'.$data->id}}"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Partner Email :</th>
                                                                    <td id="{{'agent_email'.$data->id}}"></td>
                                                                </tr>
