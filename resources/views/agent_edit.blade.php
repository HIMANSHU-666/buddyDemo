                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row d-flex justify-content-start">
                                ...
                                <form id="formAuthentication" class="mb-3" action="{{url('/') }}/updateagent" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group mb-3">
                                                ...
                                                <p><a href="{{ asset('uploads/business_logo/' . $pagedata->business_logo) }}" target="_blank"><img class="table_img" src="{{ asset('uploads/business_logo/' . $pagedata->business_logo) }}" style="height:50px !important; width:auto !important;"></a></p>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="commission_percentage" value="{{ $pagedata->commission_percentage }}" />
