                ...
                <div class="container mt-3">
                    <div class="row d-flex justify-content-start">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('/') }}/add_universities" class="p-3" enctype="multipart/form-data" id="myform" novalidate>
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="m-3">
                                                ...
                                                <input type="text" class="form-control" value="{{$uni_id;}}" name="uni_code" readonly >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="m-3">
                                                ...
                                                <input type="file" class="form-control" id="university-logo" name="uni_logo" required>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="m-3">
                                                <label class="form-label" for="university-name">University Rank<span class="text-danger"> *</span></label>
                                                <input type="number" class="form-control" id="university-logo" name="uni_rank" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="m-3">
                                                ...
                                                <input type="text" class="form-control" id="university-name" name="uni_name" placeholder="Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="m-3">
                                                <label class="form-label" for="university-location">University/College State <span class="text-danger"> *</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="m-3">
                                                ...
                                                <input type="text" class="form-control" name="distt" placeholder="Distt" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="m-3">
                                                ...
                                                <input type="text" class="form-control" name="near_by" placeholder="Near By" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="m-3">
                                                ...
                                                <input type="email" class="form-control" id="email" name="uni_email" placeholder="Email" required>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="m-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <textarea class="form-control" id="editor" name="description" rows="2" cols="50" required></textarea>
                                                </div>
                                            </div>
                                        </div>
